...
Developer Educator, Posit, PBC <br>
:::

{{< iconify ri github-fill >}} [cwickham](https://github.com/cwickham) <br>
{{< iconify ri linkedin-fill >}} [charlotte-wickham](https://www.linkedin.com/in/charlotte-wickham-793a011a/)
:::
::: {.column}
**Mine**
...
{{< iconify ri github-fill >}} [mine-cetinkaya-rundel](https://github.com/mine-cetinkaya-rundel) <br>
{{< iconify ri linkedin-fill >}} [minec](https://www.linkedin.com/in/minec/) <br>
{{< iconify ri bluesky-fill >}} [@minecr.bsky.social](https://bsky.app/profile/minecr.bsky.social)
...
::: your-turn
1. Add the `quarto-revealjs-clean` extension to the project in `01-basics/your-turns/1-install-and-explore/`, by running:

    ```{.bash filename="Terminal"}
    cd 01-basics/your-turns/1-install-and-explore/
...
::: your-turn
Still in `01-basics/your-turns/1-install-and-explore/`

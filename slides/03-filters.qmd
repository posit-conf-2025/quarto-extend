...
::: footer
`quarto-extend-exercises/03-filters/your-turns/1-explore-ast`
:::
...
* Add paragraph numbers. [Discussion](https://github.com/quarto-dev/quarto-cli/discussions/13177)
...
::: {.footer}
`quarto-extend-examples/03-filters/examples/1-writing-filters`
:::
...
## Other similar types of `Inline` elements {.smaller}

See [Pandoc LUA types Quick Reference](/modules/quick-reference.qmd#text-formatting)
...
::: footer
`03-filters/your-turns/3-simon-says`
:::
